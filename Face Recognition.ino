            ...
            <div id="content">
                <div id="sidebar">
                    ...
                    <nav id="menu">
                        ...
                        <div class="input-group" id="attendance-group">
                            <label for="attendance">Attendance Taking</label>
                            <div class="switch">
                                <input id="attendance" type="checkbox" class="default-action">
                                <label class="slider" for="attendance"></label>
                            </div>
                        </div>
                    </nav>
                </div>
          ...
          document.addEventListener('DOMContentLoaded', function (event) {
            ...
            attendance.onchange = () => {
              if (attendance.checked) {
                $.ajax({url: document.location.origin+'/control?attendance=1', async: false});
              } else {
                $.ajax({url: document.location.origin+'/control?attendance=0', async: false});
              }  
            }            
          })
        </script>
